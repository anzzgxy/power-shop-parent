...
@RunWith(SpringJUnit4ClassRunner.class) //启动时带上spring环境
@SpringBootTest(classes = {PowerShopItemApp.class}) //从启动类开始启动
public class FastDFSTest {
    ...
    public void testUpload() throws FileNotFoundException {
        // 要上传的文件
        File file = new File("C:\\Users\\86173\\Desktop\\mn\\111.png");
